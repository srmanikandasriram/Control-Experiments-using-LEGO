...
\author{S.R.Manikandasriram,~\IEEEmembership{Student Member,~IEEE,}% <-this % stops a space
}
...
\end{equation}
\begin{figure}[!hbp]
	\includegraphics[scale=•]{•}_diagram}
